...
PARAMETER_GRID = [
    {
        "backtest_name": "cat_100trees_depth3_lr003_l2_3",
        "iterations": 100,
        "depth": 3,
        "learning_rate": 0.03,
        "l2_leaf_reg": 3,
    ...
    {
        "backtest_name": "cat_100trees_depth3_lr005_l2_3",
        "iterations": 100,
        "depth": 3,
        "learning_rate": 0.05,
        "l2_leaf_reg": 3,
    ...
    {
        "backtest_name": "cat_150trees_depth3_lr003_l2_3",
        "iterations": 150,
        "depth": 3,
        "learning_rate": 0.03,
        "l2_leaf_reg": 3,
    ...
    {
        "backtest_name": "cat_150trees_depth4_lr003_l2_3",
        "iterations": 150,
        "depth": 4,
        "learning_rate": 0.03,
        "l2_leaf_reg": 3,
    ...
    {
        "backtest_name": "cat_200trees_depth3_lr003_l2_5",
        "iterations": 200,
        "depth": 3,
        "learning_rate": 0.03,
        "l2_leaf_reg": 5,
    ...
    {
        "backtest_name": "cat_200trees_depth4_lr003_l2_5",
        "iterations": 200,
        "depth": 4,
        "learning_rate": 0.03,
        "l2_leaf_reg": 5,
    ...
    {
        "backtest_name": "cat_200trees_depth3_lr005_l2_5",
        "iterations": 200,
        "depth": 3,
        "learning_rate": 0.05,
        "l2_leaf_reg": 5,
    ...
    {
        "backtest_name": "cat_200trees_depth4_lr005_l2_5",
        "iterations": 200,
        "depth": 4,
        "learning_rate": 0.05,
        "l2_leaf_reg": 5,
...
def train_models(train_df, feature_cols, horizon, model_params):
    """
    Trains two CatBoost models for one horizon:
    ...
    return_model = CatBoostRegressor(
