...
OUTPUT_DIR = "outputs"
BACKTEST_OUTPUT_PATH = os.path.join(OUTPUT_DIR, "backtest_results_xgboost.csv")
PRODUCTION_OUTPUT_PATH = os.path.join(OUTPUT_DIR, "production_forecast_xgboost.csv")
...
PARAMETER_GRID = [
    {
        "backtest_name": "xgb_100trees_depth3_lr003_child1_sub08_col08",
        "n_estimators": 100,
        "max_depth": 3,
        "learning_rate": 0.03,
        "min_child_weight": 1,
    ...
    {
        "backtest_name": "xgb_100trees_depth3_lr005_child1_sub08_col08",
        "n_estimators": 100,
        "max_depth": 3,
        "learning_rate": 0.05,
        "min_child_weight": 1,
    ...
    {
        "backtest_name": "xgb_150trees_depth3_lr003_child1_sub08_col08",
        "n_estimators": 150,
        "max_depth": 3,
        "learning_rate": 0.03,
        "min_child_weight": 1,
    ...
    {
        "backtest_name": "xgb_150trees_depth4_lr003_child1_sub08_col08",
        "n_estimators": 150,
        "max_depth": 4,
        "learning_rate": 0.03,
        "min_child_weight": 1,
    ...
    {
        "backtest_name": "xgb_200trees_depth3_lr003_child1_sub08_col08",
        "n_estimators": 200,
        "max_depth": 3,
        "learning_rate": 0.03,
        "min_child_weight": 1,
    ...
    {
        "backtest_name": "xgb_200trees_depth4_lr003_child1_sub08_col08",
        "n_estimators": 200,
        "max_depth": 4,
        "learning_rate": 0.03,
        "min_child_weight": 1,
    ...
    {
        "backtest_name": "xgb_200trees_depth3_lr005_child3_sub08_col08",
        "n_estimators": 200,
        "max_depth": 3,
        "learning_rate": 0.05,
        "min_child_weight": 3,
    ...
    {
        "backtest_name": "xgb_200trees_depth4_lr005_child3_sub08_col08",
        "n_estimators": 200,
        "max_depth": 4,
        "learning_rate": 0.05,
        "min_child_weight": 3,
...
def train_models(train_df, feature_cols, horizon, model_params):
    """
    Trains two XGBoost models for one horizon:
...
def predict_one_row(return_model, loss_model, row, feature_cols):
    ...
    if loss_model is not None:
        ...
        loss_probability = float(proba[1])
    else:
