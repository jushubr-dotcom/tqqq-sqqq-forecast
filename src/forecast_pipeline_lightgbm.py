...
OUTPUT_DIR = "outputs"
BACKTEST_OUTPUT_PATH = os.path.join(OUTPUT_DIR, "backtest_results_lightgbm.csv")
PRODUCTION_OUTPUT_PATH = os.path.join(OUTPUT_DIR, "production_forecast_lightgbm.csv")
...
PARAMETER_GRID = [
    {
        "backtest_name": "lgbm_100trees_depth3_lr003_leaves7_child20_sub08_col08",
        "n_estimators": 100,
        "max_depth": 3,
        "learning_rate": 0.03,
        "num_leaves": 7,
    ...
    {
        "backtest_name": "lgbm_100trees_depth3_lr005_leaves7_child20_sub08_col08",
        "n_estimators": 100,
        "max_depth": 3,
        "learning_rate": 0.05,
        "num_leaves": 7,
    ...
    {
        "backtest_name": "lgbm_150trees_depth3_lr003_leaves7_child20_sub08_col08",
        "n_estimators": 150,
        "max_depth": 3,
        "learning_rate": 0.03,
        "num_leaves": 7,
    ...
    {
        "backtest_name": "lgbm_150trees_depth4_lr003_leaves15_child20_sub08_col08",
        "n_estimators": 150,
        "max_depth": 4,
        "learning_rate": 0.03,
        "num_leaves": 15,
    ...
    {
        "backtest_name": "lgbm_200trees_depth3_lr003_leaves7_child30_sub08_col08",
        "n_estimators": 200,
        "max_depth": 3,
        "learning_rate": 0.03,
        "num_leaves": 7,
    ...
    {
        "backtest_name": "lgbm_200trees_depth4_lr003_leaves15_child30_sub08_col08",
        "n_estimators": 200,
        "max_depth": 4,
        "learning_rate": 0.03,
        "num_leaves": 15,
    ...
    {
        "backtest_name": "lgbm_200trees_depth3_lr005_leaves7_child30_sub07_col07",
        "n_estimators": 200,
        "max_depth": 3,
        "learning_rate": 0.05,
        "num_leaves": 7,
    ...
    {
        "backtest_name": "lgbm_200trees_depth4_lr005_leaves15_child30_sub07_col07",
        "n_estimators": 200,
        "max_depth": 4,
        "learning_rate": 0.05,
        "num_leaves": 15,
...
def train_models(train_df, feature_cols, horizon, model_params):
    """
    Trains two LightGBM models for one horizon:
